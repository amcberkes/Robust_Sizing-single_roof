...
double static alpha_d = a2_intercept*1.0; // the 1 indicates the maximum discharging C-rate (does it mean that we could discharge and charge the whole stationary battery all at once?)
