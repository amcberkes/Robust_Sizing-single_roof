...
double static num_cells_ev = 200.0; // just a default value that will be updated every time we check a new battery size
double static nominal_voltage_c_ev = 3.8793;
double static nominal_voltage_d_ev = 3.5967;
double static a1_slope_ev = 0.1920;
double static a2_slope_ev = -0.4865;
double static a1_intercept_ev = 0.0 * num_cells;
double static a2_intercept_ev = kWh_in_one_cell * num_cells;
